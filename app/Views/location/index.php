                    ...
                    <table id="locationTable" class="min-w-full text-xs sm:text-sm">
                        ...
                        <?php if (!empty($locations)) : ?>
                            <?php foreach ($locations as $loc) :
                                ...
                                $penalite       = (float)($loc->penalite ?? 0);
                                $statutPenalite = $loc->statutPenalite ?? 'aucune';

                                $penaliteDue     = ($statutPenalite === 'due'      && $penalite > 0);
                                $penaliteBloquee = ($statutPenalite === 'non_paye' && $penalite > 0);
                                $penaliteActive  = in_array($statutPenalite, ['due', 'non_paye'], true) && $penalite > 0;
                            ?>
                                <tr class="hover:bg-slate-50">
                                    ...
                                    <td class="px-4 py-2 text-right">
                                        ...
                                        <?php if ($statutPenalite === 'due'): ?>
                                            <span class="ml-1 inline-flex px-2 py-0.5 rounded-full text-[10px] bg-amber-100 text-amber-700">
                                                Due
                                            </span>
                                        <?php elseif ($statutPenalite === 'non_paye'): ?>
                                            <span class="ml-1 inline-flex px-2 py-0.5 rounded-full text-[10px] bg-red-100 text-red-700">
                                                Non payée
                                            </span>
                                        <?php elseif ($statutPenalite === 'paye'): ?>
                                            <span class="ml-1 inline-flex px-2 py-0.5 rounded-full text-[10px] bg-emerald-100 text-emerald-700">
                                                Payée
                                            </span>
                                        <?php endif; ?>
                                    </td>
                                    ...
                                    <td class="px-4 py-2 text-center">
                                        <div class="inline-flex flex-wrap gap-2 justify-center">
                                            ...
                                            <?php if ($role === 'simple' && $penaliteDue): ?>
                                                <!-- Agent simple : payer la pénalité simple -->
                                                <a href="index.php?controller=location&action=payerPenalite&id=<?= $loc->id ?>"
                                                   ...
                                                   title="Encaisser la pénalité">
                                                    <i class="fa-solid fa-coins text-[11px]"></i>
                                                </a>

                                                <!-- Agent simple : marquer non payé & bloquer -->
                                            ...
                                            <?php if (($role === 'admin' || $role === 'super' ) && $penaliteActive && $statutPenalite === 'non_paye'): ?>
                                                <!-- Admin / Super : paiement pénalité (simple ou double selon blocage) -->
                                                <a href="index.php?controller=location&action=payerPenalite&id=<?= $loc->id ?>"
                        ...
                        ?>
                            <div class="border rounded-lg p-3 bg-white shadow-sm">
                                ...
                                <div class="mt-3 flex flex-wrap justify-end gap-2">
                                    ...
                                    <?php if ($role === 'simple' && $penaliteDue): ?>
                                        <!-- Agent simple : encaissement pénalité simple -->
                                        <a href="index.php?controller=location&action=payerPenalite&id=<?= $loc->id ?>"
                                    ...
                                    <?php if (($role === 'admin' || $role === 'super') && $penaliteActive): ?>
                                    ...
                                    <?php if ($isClosed && $penalite <= 0 && $role !== 'super'): ?>
